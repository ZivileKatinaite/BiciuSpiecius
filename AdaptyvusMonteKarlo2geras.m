function [fMin2visi,fMax2visi,MINvidurkis,MAXvidurkis] = AdaptyvusMonteKarlo2geras(funkcija,a1,b1) %ka perduodam
...
%  [fMin2visi,fMax2visi,MINvidurkis,MAXvidurkis]=AdaptyvusMonteKarlo2geras(funkcija,a1,b1)
fMin2visi=[];
fMax2visi=[];
